...
VG_QUESTION_LIST = [
    DEFAULT_IMAGE_TOKEN + "\n" + "\"{question}\" Which object best matches the given description? Please respond with the 3D box.",
    DEFAULT_IMAGE_TOKEN + "\n" + "\"{question}\" Which object best matches the given description? Please output the 3D box.",
]
